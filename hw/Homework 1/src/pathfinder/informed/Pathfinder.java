 ...
 *  Purpose       :  To not fail this class
 *  @author       :  Ona Igbinedion
 *  @author       :  Andrew Forney(SearchTreeNode class)
 *  Date written  :  2020-02-07
 *  Notes         :  None right now.  We'll add some as they occur.
 *  Warnings      :  Some edge cases don't work
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *  Revision History
 *  ---------------
 *            Rev      Date     Modified by:  Reason for change/modification
 *           -----  ----------  -------------  -----------------------------------------------------------
 *  @version 1.0.0  2020-02-07  Onariaginosa   Initial writing and release
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
